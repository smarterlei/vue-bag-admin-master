                                    ...
                                    <div class="article-item-body-right" style="min-height:110px">
                                        ...
                                        <div class="action">
                                            <div class="action-tag hidden-xs-only">
                                                <it-tag :class="colorType[tidx].class" v-for="(todo, tidx) in item.keywords"
                                                    :type="colorType[tidx].type" filled style="margin-right: 5px">{{ todo }}
                                                </it-tag>
                                            </div>
                                    ...
                                    <div class="article-item-body-center">
                                        <div class="imgs">
                                            <template v-if="item.images">
                                                <a v-for="todo in item.images.split(',')"><img :src="getImageFullPath(todo)"
                                                        alt=""></a>
                                            </template>
                                        </div>
                                    </div>
                                    <div class="article-item-body-right">
                                        ...
                                        <div class="action">
                                            ...
                                            <div class="action-time hidden-xs-only hidden-sm-and-down">
                                                ...
                                                }}-{{ getDate(item.createTime).week }}</span>
                                            </div>
                                            <div class="action-user">
                                                <div class="praise">
                                                    <i style="color:#3333" class="bag-icon-dianzan5"></i>
